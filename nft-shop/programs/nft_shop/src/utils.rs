...
pub fn mpl_mint_new_edition_from_master_edition_via_token<'a>(
    ...
    // ### Arguments:
    //
    //   0. Token Metadata Program ID
    //   1. New Metadata
    //   2. New Edition
    //   3. Master Edition
    //   4. New Mint
    //   5. New Mint Authority
    //   6. Payer
    ...
    //   3. `[w]` New Mint
    //   4. `[w]` Edition Marker
    //   5. `[s]` New Mint Authority
    //   6. `[w, s]` Payer
    //   7. `[s]` Token Account Owner
    //   8. `[]` Token Account
    //   9. `[]` New Metadata Update Authority
    //   10. `[]` Metadata
    //   11. `[]` Token Program
...
pub fn mpl_update_primary_sale_happened_via_token<'a>(
    ...
    //
    // ### More:
    //   https://docs.metaplex.com/programs/token-metadata/instructions#indicate-the-primary-sale-has-happened
    //
    invoke_signed(
